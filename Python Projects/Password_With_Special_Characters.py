...
for i in range(5): # We want our password to 15 characters (3*5 = 15)
    ...
    password = str(password) + i + j + k  # Takes our empty string and adds the random characters we have assigned above. This is repeated 5 times.
print(password)
